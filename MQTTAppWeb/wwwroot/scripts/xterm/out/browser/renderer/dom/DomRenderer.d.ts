...
export declare class DomRenderer extends Disposable implements IRenderer {
    ...
    constructor(_colors: IColorSet, _element: HTMLElement, _screenElement: HTMLElement, _viewportElement: HTMLElement, _linkifier: ILinkifier, _linkifier2: ILinkifier2, instantiationService: IInstantiationService, _charSizeService: ICharSizeService, _optionsService: IOptionsService, _bufferService: IBufferService);
    dispose(): void;
